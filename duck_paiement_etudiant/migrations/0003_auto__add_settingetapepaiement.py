...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SettingEtapePaiement'
        db.create_table(u'duck_paiement_etudiant_settingetapepaiement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('etape', self.gf('django.db.models.fields.related.ForeignKey')(related_name='settings_etape_paiement', to=orm['django_apogee.Etape'])),
            ('cod_anu', self.gf('django.db.models.fields.IntegerField')(default=2014)),
            ('tarif', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('demi_annee', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('nb_paiment_max', self.gf('django.db.models.fields.IntegerField')(default=2)),
            ('demi_tarif', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'duck_paiement_etudiant', ['SettingEtapePaiement'])


    def backwards(self, orm):
        # Deleting model 'SettingEtapePaiement'
        db.delete_table(u'duck_paiement_etudiant_settingetapepaiement')
