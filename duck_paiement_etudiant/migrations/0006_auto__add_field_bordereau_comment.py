...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bordereau.comment'
        db.add_column(u'duck_paiement_etudiant_bordereau', 'comment',
                      self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bordereau.comment'
        db.delete_column(u'duck_paiement_etudiant_bordereau', 'comment')
    ...
    models = {
        ...
        u'duck_paiement_etudiant.bordereau': {
            ...
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '120', 'null': 'True', 'blank': 'True'}),
