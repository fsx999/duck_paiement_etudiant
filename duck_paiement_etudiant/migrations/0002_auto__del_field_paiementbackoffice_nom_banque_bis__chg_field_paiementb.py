...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PaiementBackoffice.nom_banque_bis'
        db.delete_column(u'pal_paiement_backoffice', 'nom_banque_bis_id')


        # Renaming column for 'PaiementBackoffice.nom_banque' to match new field type.
        db.rename_column(u'pal_paiement_backoffice', 'nom_banque', 'nom_banque_id')
        # Changing field 'PaiementBackoffice.nom_banque'
        db.alter_column(u'pal_paiement_backoffice', 'nom_banque_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['duck_paiement_etudiant.Banque'], null=True))
        # Adding index on 'PaiementBackoffice', fields ['nom_banque']
        db.create_index(u'pal_paiement_backoffice', ['nom_banque_id'])


    def backwards(self, orm):
        # Removing index on 'PaiementBackoffice', fields ['nom_banque']
        db.delete_index(u'pal_paiement_backoffice', ['nom_banque_id'])

        # Adding field 'PaiementBackoffice.nom_banque_bis'
        db.add_column(u'pal_paiement_backoffice', 'nom_banque_bis',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['duck_paiement_etudiant.Banque'], null=True, blank=True),
                      keep_default=False)


        # Renaming column for 'PaiementBackoffice.nom_banque' to match new field type.
        db.rename_column(u'pal_paiement_backoffice', 'nom_banque_id', 'nom_banque')
        # Changing field 'PaiementBackoffice.nom_banque'
        db.alter_column(u'pal_paiement_backoffice', 'nom_banque', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))
