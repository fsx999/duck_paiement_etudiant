...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pal_paiement_backoffice', (
            ...
            ('nom_banque', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
            ('nom_banque_bis', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['duck_paiement_etudiant.Banque'], null=True, blank=True)),
    ...
    models = {
        ...
        u'duck_paiement_etudiant.paiementbackoffice': {
            ...
            'nom_banque': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True', 'blank': 'True'}),
            'nom_banque_bis': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['duck_paiement_etudiant.Banque']", 'null': 'True', 'blank': 'True'}),
