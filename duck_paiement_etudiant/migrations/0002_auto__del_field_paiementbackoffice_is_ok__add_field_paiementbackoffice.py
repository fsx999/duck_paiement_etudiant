...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PaiementBackoffice.is_ok'
        db.delete_column(u'pal_paiement_backoffice', 'is_ok')

        # Adding field 'PaiementBackoffice.is_not_ok'
        db.add_column(u'pal_paiement_backoffice', 'is_not_ok',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PaiementBackoffice.is_ok'
        db.add_column(u'pal_paiement_backoffice', 'is_ok',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'PaiementBackoffice.is_not_ok'
        db.delete_column(u'pal_paiement_backoffice', 'is_not_ok')
